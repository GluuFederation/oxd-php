...
- [Library version 3.0.0](https://github.com/GluuFederation/oxd-php-api/releases/tag/v3.0.0)
...
```
$ composer install `composer require "gluufederation/oxd-php-api": "3.0.0"`
